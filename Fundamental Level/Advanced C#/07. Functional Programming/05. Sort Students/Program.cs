	...
	class Program
	{
		static void Main(string[] args)
		{
			List<Student> students = new List<Student>(){
				...
				new Student("pesho", "be", 25, "00321", "32-13-314", "pesho@abv.bg", new List<int>(){ 1, 6, 5, 6, 4, 6 }, 1)
			};

			var studentsByAgeLINQ = students.OrderBy(student =>student.FirstName).ThenBy(student=>student.LastName).ToArray();

			foreach (var student in studentsByAgeLINQ)
			{
